...
class ObfuscateRuleSync:
    def __init__(self, redis_host, redis_port, redis_db, redis_password, hashset_name, interval_seconds):
        self.redis_client = redis_client.RedisClient(host=redis_host, port=redis_port, db=redis_db, password=redis_password)
    ...
    def fetch_and_process_obfuscate_rules(self):
        ...
        for rule_id in rule_ids:
            ...
            if obfuscate_rule:
                ...
                print("Added to list.")
        presidio_engine.presidio_engine_obj.updateObfuscationRules(new_rules)
